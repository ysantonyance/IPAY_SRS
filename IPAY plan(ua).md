...
Amazon Clone розробляється як самостійний навчальний продукт з нуля, проте архітектурні та UX-рішення базуються на кращих практиках сучасних e-commerce платформ. Система складається з клієнтської частини (React SPA), серверної частини (ASP.NET Core Web API) та шару даних (Firebase).
...
| Продавець(Персональне/Бізнес) | Авторизований користувач+ | Кошик, оформлення замовлення, історія покупок, відгуки, обране, профіль, можливість продажи товару |
...
| БД | Firebase Firestore | Опціонально для real-time сповіщень або кешування сесій |
...
| A-03 | Команда дотримується Scrum: 2-тижневі спринти, щоденні stand-up, Kanban-дошка | Методологічна | Неможливість надати звіт по Scrum |
| A-04 | Всі члени команди мають базові знання C#, React та Firebase | Компетенційна | Необхідність додаткового навчання, ризик зриву термінів |
...
- Пошук з фільтрацією та пагінацією (Elasticsearch)
...
| ID | Вимога |
|---|---|
| NFR-12 | Архітектура Clean / Onion |
